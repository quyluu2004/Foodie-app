...
export default function CommentsReceivedListScreen() {
  const { user } = useAuth();
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const response = await statsAPI.getCommentsReceived();
      ...
      console.error('❌ Error loading comments received:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Người đã bình luận</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>Chưa có ai bình luận bài đăng của bạn</Text>
          </View>
        }
